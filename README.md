...
| 날짜       | 내용                                                                                                                                                                                                                   |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026.03.01 | 최초 구성 (rules / command / skills)                                                                                                                                                                                   |
| 2026.03.11 | setup.ps1 한글 출력 UTF-8 인코딩 설정<br>README 팀 공유 가이드 정리(처음 설치/pull/사용법, 팀원·관리자 구분)<br>팀 공통 QC·QA 체크리스트 반영<br>qc_report 코드 검사 vs 작업자 직접 확인 리스트 분리 및 출력 형식 정리 |
